...
muestra_do_de_prov<-rbind(dores7,deres7)
...
muestra_do_de_nac<-rbind(dores7,deres7)
...
muestra_do_de_area<- rbind(dores7,de_res7)
...
muestra_do_de_dom10<- rbind(dores7,deres7)
